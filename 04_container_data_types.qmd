...
## Lists (`list`) {#sec-list}
xxx add what slicing and indexing refers to. add two examples
...
Python has very expressive (i.e. short) ways to alter container data types. The general form is (where "iterable" is a container data type):
```
