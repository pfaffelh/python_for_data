...
print(f"{d['first_name']} {d['last_name']} is {d['age']} and likes {', '.join(d['hobbies'])}")
```
...
```{python}
print(f"{p['first_name']} {p['last_name']} lives in {p.get('address')}".)
# This version uses a default field in get
print(f"{p['first_name']} {p['last_name']} lives in {p.get('address', 'unknown')}".)
```
...
print(f"The key-value-pairs are {d.items()}.")
```
...
for p in people:
    print(f"{p["first_name"]} {p["last_name"]} is {p["age"]} and likes {", ".join(p["hobbies"])}")
