...
Sometimes, you want to store intermediate objects. One way is to write them out in files, but you can also use the `pickle`-library in order to write Python objects to disc. Here is an example:
