...
1. **A 45-minute multiple choice exam before Pentecost (Pfingsten).** The exam covers the Python basics from Chapters 2–5 (simple data types, control flow, container data types, and libraries). The exam is held on paper — **no computers** (and no books or notes) are allowed.
