...
The third part of this course is a small data analysis project that you carry out in groups of 2. The goal is to apply the skills from chapters 02–09 to a topic of your choice. Use `git` and either [GitHub](https://github.com) or the [university GitLab](https://gitlab.uni-freiburg.de/) to share code within your group (see @sec-git for an introduction). The repository should be public (or shared with the instructor) so that the instructors can follow your progress. Here is the timeline:
