...
**Exercise 9**
The following function is supposed to compute the average of a list of numbers, but it contains a subtle bug. Find and fix it. (Hint: try it with a few inputs and compare the result to what you expect. Debugging with `print` statements or the built-in debugger can help — see @sec-debugging.)
