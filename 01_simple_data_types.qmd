...
When analysing datam it is common to have missing values. These usually come as `None`. This is different from anything else we encountered so far (including `nan` and `False`).
